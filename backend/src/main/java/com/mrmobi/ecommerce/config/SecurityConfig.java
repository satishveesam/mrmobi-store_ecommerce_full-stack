    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/orders/bulk").permitAll()
                        .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/orders/*/cancel").hasRole("USER")
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/reviews/can-rate/**").hasRole("USER")
                        .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/reviews").hasRole("USER")
